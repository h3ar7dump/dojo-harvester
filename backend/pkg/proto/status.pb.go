...
const file_status_proto_rawDesc = "" +
	"\n" +
	"\fstatus.proto\x12\x06status\"_\n" +
	"\fStatusUpdate\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessageB-Z+github.com/dojo-harvester/backend/pkg/protob\x06proto3"
...
var file_status_proto_goTypes = []any{
	(*StatusUpdate)(nil), // 0: status.StatusUpdate
}
